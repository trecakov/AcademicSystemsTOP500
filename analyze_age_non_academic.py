#
# This script extracts age statistics from Top500_without_Academic directory and outputs the csv file over the years.
#
...
def analyze_year_field(input_dir="Top500_without_Academic", output_file="year_field_statistics_non_academic.csv"):
