#
# This script extracts system perfomance statistics and calculate Rmax/Rpeak from a directory and outputs csv.
...
def calculate_system_performance(input_dir, output_file="system_performance_statistics.csv"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Extract system performance (Rmax/Rpeak) statistics from a directory"
    )
    parser.add_argument("input_dir", help="Path to directory containing CSV files")
    parser.add_argument(
        "-o", "--output",
        default="system_performance_statistics.csv",
        help="Path to output CSV file (default: system_performance_statistics.csv)"
    )
    args = parser.parse_args()

    df = calculate_system_performance(args.input_dir, args.output)
