#
# This script extracts age statistics from TOP500lists directory and outputs the csv file over the years.
# It outputs quantiles, mean, meadian, highest and lowest age, and top systems.
#
# To run script 'python3.6 analyze_age.py <lists directory> -o <output file name>'
#
...
def analyze_year_field(input_dir, output_file="age_statistics.csv"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Extract system age (Year field) statistics from a directory"
    )
    parser.add_argument("input_dir", help="Path to directory containing CSV files")
    parser.add_argument(
        "-o", "--output",
        default="year_field_statistics.csv",
        help="Path to output CSV file (default: age_statistics.csv)"
    )
    args = parser.parse_args()

    df = analyze_year_field(args.input_dir, args.output)
