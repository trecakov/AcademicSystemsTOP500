#
# This script extracts the power statistics form Top500_without_Academic directory from 06/2008 and outputs the csv file.
...
def extract_power_statistics(input_dir="Top500_without_Academic", output_file="power_statistics_non_academic.csv"):
