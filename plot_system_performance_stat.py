#
# This script plots system performance statistics (Rmax/Rpeak) using box plot.
#
# To run script 'python3.6 plot_system_performance_stat.py'
#
...
def plot_system_performance_boxplot(csv_file="system_performance_statistics.csv", output_file="system_performance_boxplot.png"):
    ...
    if any(y is not None for y in top_system_data):
        ...
        ax.scatter(valid_positions, valid_top_performance, marker='o', s=80,
    ...
    ax.set_ylabel('System Performance (Rmax/Rpeak)', fontsize=12, fontweight='bold')
