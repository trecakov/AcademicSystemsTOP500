#
# This script extracts energy efficiency statistics from AllListsAcademia directory and outputs the csv file.
...
def calculate_energy_efficiency_quantiles(input_dir="AllListsAcademia", output_file="energy_efficiency_quantiles.csv"):
